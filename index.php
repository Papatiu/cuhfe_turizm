...
// 3. Öne Çıkan Turları Çek (Sadece 3 Tane)
try {
...
<body>
    ...
    <!-- === ÖNE ÇIKAN TURLAR (SON VE KESİN DÜZELTİLMİŞ) === -->
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 d-flex">
                            <div class="card tour-card-v2 h-100 shadow-sm w-100">
                                <div class="tour-image-container">
                                    ...
                                    // Eğer slug yoksa veya boşsa, link oluşturma. '#' linki ver.
                                    $tour_slug = $tour['slug'] ?? '#';
                                    ...
                                    <div class="tour-price-banner">
                                        <?php if (!empty($tour['old_price']) && $tour['old_price'] > 0): ?>
                                            <span class="old-price"><?php echo number_format($tour['old_price'], 0); ?>
                                                <?php echo htmlspecialchars($tour['currency'] ?? 'USD'); ?></span>
                                        <?php endif; ?>
                                        <?php echo number_format($tour['price'] ?? 0, 0); ?>
                                        <?php echo htmlspecialchars($tour['currency'] ?? 'USD'); ?> <small>Kişi başı</small>
                                    </div>
                                </div>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <ul class="tour-details list-unstyled">
                                        <li><i class="fas fa-map-marker-alt"></i> <strong>Medine:</strong>
                                            <?php echo htmlspecialchars($tour['medina_hotel'] ?? 'Belirtilmedi'); ?></li>
                                        <li><i class="fas fa-map-marker-alt"></i> <strong>Mekke:</strong>
                                            <?php echo htmlspecialchars($tour['mecca_hotel'] ?? 'Belirtilmedi'); ?></li>
                                        <li><i class="fas fa-moon"></i> <strong>Süre:</strong>
                                            <?php echo htmlspecialchars(($tour['duration_medina'] ?? 0) + ($tour['duration_mecca'] ?? 0)); ?> Gün</li>
                                        <li><i class="fas fa-plane-departure"></i> <strong>Gidiş Tarihi:</strong>
                                            <?php echo date('d.m.Y', strtotime($tour['departure_date'] ?? 'now')); ?></li>
                                        <li><i class="fas fa-plane-arrival"></i> <strong>Dönüş Tarihi:</strong>
                                            <?php echo date('d.m.Y', strtotime($tour['return_date'] ?? 'now')); ?></li>
                                    </ul>
