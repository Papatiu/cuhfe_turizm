<?php
// admin/hac_turlari.php
$page_title = "Hac Turları Yönetimi";
require_once 'includes/header.php';

// Veritabanından sadece 'hac' tipindeki turları çek
$stmt = $db->prepare("SELECT * FROM tours WHERE tour_type = 'hac' ORDER BY departure_date DESC");
$stmt->execute();
$hac_tours = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>

<!-- BAŞARI/HATA MESAJLARI (Tur ekleme/silme sonrası için) -->
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="m-0">Hac Turları</h2>
    <a href="tur_ekle.php?type=hac" class="btn btn-success"><i class="fas fa-plus me-2"></i> Yeni Hac Turu Ekle</a>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="toursTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center py-4">Henüz eklenmiş Hac turu bulunmamaktadır.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
